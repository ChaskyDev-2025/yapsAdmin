...
export const agregarHistorialRecarga = async (
  uid,
  { estado = "recarga", monto } = {}
) => {
  try {
    ...
    // Referencia al documento dentro de la colección historial-saldo
    // Estructura: users/{uid}/historial-saldo/{año-mes-dia}
    // Esto tiene 4 segmentos (par) - válido para un documento
    ...
    if (docSnap.exists()) {
      ...
      await updateDoc(historialRef, {
        // Agregamos el año y mes para poder filtrar después
        año: año.toString(),
        mes: mesNombre,
