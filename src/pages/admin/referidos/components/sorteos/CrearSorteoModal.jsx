    ...
    <DialogContent sx={{ pt: 3 }}>
      <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
        <TextField
          ...
          onChange={(e) => onChange({ ...nuevoSorteo, id: e.target.value })}
        ...
        <TextField
          ...
          onChange={(e) => onChange({ ...nuevoSorteo, descripcion: e.target.value })}
        ...
        <FormControl fullWidth>
          ...
          <Select
            ...
            onChange={(e) => onChange({ ...nuevoSorteo, modo: e.target.value })}
        ...
        <FormControl fullWidth>
          ...
          <Select
            ...
            onChange={(e) => onChange({ ...nuevoSorteo, departamentos: e.target.value })}
        ...
        <TextField
          ...
          onChange={(e) => onChange({ ...nuevoSorteo, fechaInicio: e.target.value })}
          size="small"
        ...
        <TextField
          ...
          onChange={(e) => onChange({ ...nuevoSorteo, fechaFin: e.target.value })}
          size="small"
          InputLabelProps={{ shrink: true }}
        />
        <FormControl fullWidth>
          ...
          <Select
            ...
            onChange={(e) => onChange({ ...nuevoSorteo, categorias: e.target.value })}
